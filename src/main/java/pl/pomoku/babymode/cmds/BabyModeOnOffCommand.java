        ...
        if (sender instanceof Player) {
            ...
            switch (args.length) {
                case 0:
                    ...
                    p.sendMessage(" ");
                    p.sendMessage(" §8>> §f/bm §7- pomoc.");
                    p.sendMessage(" §8>> §6/bm §7- plugin.");
                    p.sendMessage(" §8>> §f/bm §fall §7- wszystko.");
                    p.sendMessage(" §8>> §6/bm §6killmobs §7- zabijania potworow.");
                    p.sendMessage(" §8>> §f/bm §fextinguishing §7- gaszenie.");
                    p.sendMessage(" §8>> §6/bm §6create_portal §7- tworzenie portalu.");
                    p.sendMessage(" §8>> §f/bm §fauto_enchant §7- automatyczne ulepszanie.");
                    p.sendMessage(" §8>> §6/bm §6block_explode §7- blokowanie wybuchow.");
                    p.sendMessage(" §8>> §f/bm §fauto_cook §7- automatyczne przepalanie.");
                    p.sendMessage(" §8>> §6/bm §6block_item_burn §7- splanie itemow.");
                    p.sendMessage(" §8>> §f/bm §fmake_obs §7- tworzenie obsydianu.");
                    p.sendMessage(" §8>> §6/bm §6more_loot §7- wiekszony loot.");
                    p.sendMessage(" §8>> §f/bm §frespawn_animals §7- odradzanie zwierzat.");
                    p.sendMessage(" §8>> §6/bm §6block_enderman §7- block endermanow.");
                    p.sendMessage(" §8>> §f/bm §fjoin_nether §7- startpack w netherze.");
                    p.sendMessage(" ");
                    p.sendMessage("§8[§b+§8]§m------------§r§8[ §bBABY MODE §8]§m------------§r§8[§b+§8]");
                    p.sendMessage(" ");
                    break;
